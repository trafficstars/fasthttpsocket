...
var (
	...
	ErrNotEnoughWords      = errors.New(`[fasthttp-socket] invalid address, expected syntax "datamodel:serializer:family:address", example "raw:native:unixpacket:/run/myserver.sock"`)
